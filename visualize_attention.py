...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='./train-100/checkpoint.pth', type=str,                                                   #
                        help="Path to pretrained weights to load.")
    parser.add_argument("--checkpoint_key", default="teacher", type=str,
        help='Key to use in the checkpoint (example: "teacher")')
    parser.add_argument("--image_path", default=None, type=str, help="Path of the image to load.")    # 要绝对路径
    parser.add_argument("--image_size", default=(480, 480), type=int, nargs="+", help="Resize image.")          
    parser.add_argument('--output_dir', default='attention-100', help='Path where to save visualizations.')                         #
