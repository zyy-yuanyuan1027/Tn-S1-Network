...
def eval_linear(args):
    ...
    utils.load_pretrained_weights(model2, args.pretrained_weights, args.checkpoint_key2, args.arch,
                                  args.patch_size)
    print(f"Model1 and Model2 {args.arch} built.")
    ...
    if args.evaluate:
        ...
        test_stats = validate_network(val_loader, model1, model2, linear_classifier, args.n_last_blocks,
    ...
    for epoch in range(start_epoch, args.epochs):
        ...
        train_stats = train(model1, model2, linear_classifier, optimizer,
...
if __name__ == '__main__':
    ...
    parser.add_argument('--pretrained_weights', default='../T2-S2 Network/checkpoint.pth', type=str,
